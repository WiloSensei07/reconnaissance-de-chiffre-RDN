...
model1.add(Convolution2D(16,(3,3),activation='relu',input_shape=(28,28,1))) #couche de 16 noyaux de convolution, sans zero padding, avec un masque de dimension 3x3, un
                                                                        #pas de 1, et une fonction d'activation ReLU
model1.add(MaxPooling2D(pool_size=(2,2))) #couche de max pooling, de dimension 2x2
...
model1.save('modele_TP2_avecConv2D.h5');
